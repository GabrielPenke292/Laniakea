...
<div class="col-md-9">
    ...
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
        ...
        <div class="col-12">
            <ul class="list-group">
                <li><button type="button" class="list-group-item btn btn-outline-primary mb-2 disabled">Renegociar Parcelas</button></li>
                <li><button type="button" class="list-group-item btn btn-outline-primary mb-2 disabled">Revisão de juros</button></li>
                <li><button type="button" class="list-group-item btn btn-outline-primary mb-2 disabled">Alteração de prazo</button></li>
                <li><button type="button" class="list-group-item btn btn-outline-primary mb-2 disabled">Pagamento único com desconto</button></li>
            </ul>
        </div>
        <hr>
        <div class="renegociacao-sumario container-fluid card p-3">
